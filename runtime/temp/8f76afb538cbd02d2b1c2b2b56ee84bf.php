<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"C:\phpStudy\WWW\mimishop/application/admin\view\rank\edit.html";i:1492946682;s:64:"C:\phpStudy\WWW\mimishop/application/admin\view\common\head.html";i:1482462994;s:66:"C:\phpStudy\WWW\mimishop/application/admin\view\common\header.html";i:1482462994;s:66:"C:\phpStudy\WWW\mimishop/application/admin\view\common\navbar.html";i:1477622210;s:66:"C:\phpStudy\WWW\mimishop/application/admin\view\common\footer.html";i:1490016441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/rank/index'); ?>">等级</a></li>
        <li class="active"><a href="<?php echo url('admin/member/add'); ?>">添加等级</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <form method="post" action=<?php echo url('edit'); ?> id="edit">
                <div class="box-body">
                <div class="form-group">
                    <label for="uname" id="uname_label" class="uname">等级名称</label>
                    <input class="form-control" id="rank_name" name="rank_name" value="<?php echo $user_rank['rank_name']; ?>" placeholder="等级名称" type="text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1" class="nname">积分下线</label>
                    <input class="form-control" id="min_points" name="min_points" value="<?php echo $user_rank['min_points']; ?>" placeholder="积分下线" type="text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1" class="nname">积分上线</label>
                    <input class="form-control" id="max_points" name="max_points" value="<?php echo $user_rank['max_points']; ?>" placeholder="积分上线" type="text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1" class="discount">初始折扣率</label>
                    <input class="form-control" id="discount" name="discount" placeholder="初始折扣率" value="<?php echo $user_rank['discount']; ?>" type="text">
                  </div>
                  <div class="pull-right">
                <button class="btn btn-success" onclick="javascript:history.back(-1);return false;">返 回</button>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="hidden" name="rank_id" value="<?php echo $user_rank['rank_id']; ?>">
