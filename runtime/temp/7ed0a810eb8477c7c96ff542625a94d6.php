<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"C:\phpStudy\WWW\mimishop/application/admin\view\menu\edit.html";i:1491375589;s:64:"C:\phpStudy\WWW\mimishop/application/admin\view\common\head.html";i:1482462994;s:66:"C:\phpStudy\WWW\mimishop/application/admin\view\common\header.html";i:1482462994;s:66:"C:\phpStudy\WWW\mimishop/application/admin\view\common\navbar.html";i:1477622210;s:66:"C:\phpStudy\WWW\mimishop/application/admin\view\common\footer.html";i:1490016441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <!-- Font Awesome Icons -->
              <form  action="<?php echo url('edit'); ?>" method="post" id="editMenu">
                <div class="form-group">
                  <label for="exampleInputEmail1">名称 </label>
                  <input type="text" class="form-control" value="<?php echo $menuInfo['name']; ?>" name="name" placeholder="用于后台显示的配置标题" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">图标 </label>
                  <input type="text" class="form-control" value="<?php echo $menuInfo['icon']; ?>" name="icon" placeholder="菜单图标" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">链接</label>
                  <input type="text" class="form-control" value="<?php echo $menuInfo['url']; ?>" name="url" placeholder="url函数解析的URL或者外链" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">排序</label>
                  <input type="text" class="form-control" value="<?php echo $menuInfo['sort']; ?>" name="sort" placeholder="用于分组显示的顺序">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">上级菜单</label>
                  <select class="form-control pidSelect" name="pid">
                   <option value="0">无</option>
                   <?php echo tree_to_menu_select($menuTree); ?>
                 </select>
                </div>
               <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="id" value="<?php echo $menuInfo['id']; ?>" name="id"  />
            </form>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
...
<script>
 $().ready(function (argument) {
    ...
    // 设置select选中
    $(".pidSelect").val("<?php echo $menuInfo['pid']; ?>");
    $(".hideSelect").val("<?php echo $menuInfo['hide']; ?>");
 });
</script>
<!-- Bootstrap 3.3.6 -->
